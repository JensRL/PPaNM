...
public class lsfit{
	public static (double[], matrix) leastsqfit(double[] x, double[] y, double[] dy, Func<double,double>[] fs){ 
		...
		matrix R2 = new matrix(RTR.size2, RTR.size2);
		lineareq.QRGS(RTR, R2);
		matrix S = 	lineareq.QRGSInverse(RTR, R2);
